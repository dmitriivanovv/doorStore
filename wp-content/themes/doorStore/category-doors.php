	...
	?>
		<div class="container">
			...
			<div class="category-controll text-center">
				...
				<button class="btn" type="button" data-filter=".<?= get_category( 15, ARRAY_A )['slug']; ?>">
					<?= get_category( 15, ARRAY_A )['name']; ?>
				</button>
				<button class="btn" type="button" data-filter=".<?= get_category( 16, ARRAY_A )['slug']; ?>">
					<?= get_category( 16, ARRAY_A )['name']; ?>
				</button>
